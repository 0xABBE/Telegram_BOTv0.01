...
class StyleTransferModel:
    def __init__(self, content_layers=['conv_4'],
        ...
        self.cnn = torch.load('VGG19_Style_Transfer/model_scripted.txt').to(device).eval()
    ...
    def get_input_optimizer(self, input_img):
        optimizer = self.optimizer([input_img.requires_grad_()])
        return optimizer
    ...
    def run_style_transfer(self, content_img, style_img, input_img,
        ...
        model, style_losses, content_losses = self.get_style_model_and_losses(normalization_mean,
